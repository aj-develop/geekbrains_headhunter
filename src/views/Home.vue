    ...
    <main>
      <section class="features">
        <div class="features-block">
          ...
          <h4 class="features-block-title">Web & App Design</h4>
        ...
        <div class="features-block">
          ...
          <h4 class="features-block-title">Development</h4>
          <p class="features-block-text">
        ...
        <div class="features-block">
          ...
          <h4 class="features-block-title">Customization</h4>
          <p class="features-block-text">
            Nam liber tempor cum soluta nobis eleifend option congue nihil
            imperdiet doming id quod mazim.
          </p>
        ...
        <div class="features-block">
          ...
          <h4 class="features-block-title">Marketing</h4>
          <p class="features-block-text">
            Nam liber tempor cum soluta nobis eleifend option congue nihil
            imperdiet doming id quod mazim.
          </p>
