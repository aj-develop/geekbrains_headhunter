    ...
    <main>
      <section class="features">
        <div class="features-block">
          ...
          <h4 class="features-block-title">Вакансии дня</h4>
          <p class="features-block-text">
            35 000 - 75 000 руб.
          </p>
          <p class="features-block-text-bottom">
            14 вакансий
          </p>
        </div>
        <div class="features-block">
          ...
          <h4 class="features-block-title">Компании дня</h4>
          <p class="features-block-text">
            435
          </p>
          <p class="features-block-text-bottom">
        ...
        <div class="features-block">
          ...
          <h4 class="features-block-title">Работа из дома</h4>
          <p class="features-block-text">
            56437
          </p>
          <p class="features-block-text-bottom">
        ...
        <div class="features-block">
          ...
          <h4 class="features-block-title">Подработка</h4>
          <p class="features-block-text">
            35 000 - 75 000 руб.
          </p>
          <p class="features-block-text-bottom">
      ...
      <section class="statistics">
        <div class="statistics-block">
          ...
          <span class="statistics-block-digits">3587</span>
          <span class="statistics-block-text">РЕЗЮМЕ</span>
        </div>
        <div class="statistics-block">
          <svg
            class="statistics-block-svg"
          ...
          <span class="statistics-block-digits">2500</span>
          <span class="statistics-block-text">ВАКАНСИЙ</span>
        </div>
        <div class="statistics-block">
          <svg
            class="statistics-block-svg"
          ...
          <span class="statistics-block-digits">873</span>
      ...
      <section class="for-mobile">
        <img
          src="../assets/img/i-phone-in-hand.png"
          width="423"
          height="616"
          alt="mobile"
        />
        <div class="for-mobile-block-text">
          <h3 class="section-title">Адаптировано для мобильных устройств</h3>
          <p class="section-text">
            Хорошая работа — мечта многих, поэтому так важно не упустить свой
            шанс и найти вакансию, которая подходит именно вам. На GeekJob вы
            обнаружите большое количество вакансий в различных отраслях
            деятельности: от сотрудников сферы обслуживания до топ-менеджеров
            крупных компаний. Используйте нашу обширную информационную базу — и
            подходящая работа найдется быстро, ведь GeekJob сотрудничает со
            множеством предприятий-работодателей.
          </p>
          <ul class="for-mobile-list">
            <li>
              <svg
                class="for-mobile-list-svg"
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
                width="21"
                height="21"
              ...
              <span>Простота и удобство использования;</span>
            </li>
            <li>
              <svg
                class="for-mobile-list-svg"
              ...
              <span>Возможность получения актуальной информации;</span>
            </li>
            <li>
              <svg
                class="for-mobile-list-svg"
              ...
              <span>Удобные фильтры для поиска;</span>
            </li>
            <li>
              <svg
                class="for-mobile-list-svg"
